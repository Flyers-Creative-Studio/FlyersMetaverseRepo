...
public class SwimPack : MonoBehaviour
{
  
    [SerializeField] private int swimPackForce = 20;
    ...
    void StartSwimPack()
    {
        ...
        _controller.Move(move * Time.deltaTime * swimPackForce);
        ...
        // move the player
            ...
            {
                _controller.Move(Vector3.up * Time.deltaTime * swimPackForce);
               this.transform.GetChild(1).transform.localEulerAngles = new Vector3(-20, 0, 0);
            }
            else
            {
                if (_mainCamera.GetComponent<CameraController>()._cinemachineTargetPitch >1)
                {
                    _controller.Move(Vector3.down * Time.deltaTime * swimPackForce);
                ...
                else if (_mainCamera.GetComponent<CameraController>()._cinemachineTargetPitch < 0)
                {
